# Generated by Django 2.1.7 on 2019-04-09 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paytm_qr', models.ImageField(upload_to='photos/%Y/%m/%d/')),
            ],
        ),
        migrations.CreateModel(
            name='Shopkeeper',
        ...
        migrations.AddField(
            model_name='shop',
            name='shopkeeper',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.Shopkeeper'),
        ),
        migrations.AddField(
